...
if (context.window.NilSparkLabConfig.version !== '11.5') throw new Error('Version mismatch');
...
if (context.window.NilSparkLabConfig.version !== '11.5') throw new Error('Config is not frozen');
