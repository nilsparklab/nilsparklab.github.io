...
export const env = Object.freeze({
  ...
  // Where sync-push/sync-pull store each device's opted-in progress snapshot.
  // On ephemeral hosts (free-tier Render/Railway etc.) this directory does
  // NOT survive a redeploy — fine for a low-stakes convenience feature, but
  // worth knowing before relying on it for anything important.
